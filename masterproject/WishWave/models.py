...
class CakeAndGift(models.Model):
    ...
    cake_shop_name = models.CharField(max_length=100,blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True,blank=True, null=True)
    cake_from_address = models.CharField(max_length=255,blank=True, null=True)
    cake_from_city = models.CharField(max_length=100,blank=True, null=True)
    cake_from_state = models.CharField(max_length=100,blank=True, null=True)
    cake_from_pincode = models.CharField(max_length=10,blank=True, null=True)
    ...
    gift_shop_name = models.CharField(max_length=100,blank=True, null=True)
    gift_from_address = models.CharField(max_length=255,blank=True, null=True)
    gift_from_city = models.CharField(max_length=100,blank=True, null=True)
    gift_from_state = models.CharField(max_length=100,blank=True, null=True)
    gift_from_pincode = models.CharField(max_length=10,blank=True, null=True)
